                     ...
                     <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <a href="/listAllComTerminer" class="float-end"><button type="button" class="btn btn-outline-info rounded-pill ms-5"><i class="uil-plus-circle"></i> Commande Terminer</button> </a>
                                </h4>
                                </div>
                            </div>
                        </div>
