                                        ...
                                        <div class="tab-pane show active" id="input-types-preview">
                                            <div class="row">
                                                 <div class="col-lg-11 mt-4 ms-1">
                                                    <form action="{{ route('AddTemoignage') }}" method="POST" enctype="multipart/form-data">
                                                      @csrf 
                                                      @method('POST')
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                                ...
                                                                <input name="profession" type="text" id="example-palaceholder" class="form-control" placeholder="Entrer la profession">
                                                            </div>

                                                       <h5 class="mb-3 mt-4">Message</h5>
                                                              <div class="form-floating">
                                                                  <textarea class="form-control" name="message" placeholder="Entrer le temoignage" id="floatingTextarea"
                                                                      style="height: 100px"></textarea>
                                                                  <label for="floatingTextarea">Entrer le Temoignages</label>
                                                              </div>
                                                          </div>
