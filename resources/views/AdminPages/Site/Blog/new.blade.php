 ...
 <!-- ============================================================== -->
            ...
            <div class="content-page">
                ...
                @if ( session('success'))
                    ...
                    Nouveau blog sauvegarder avec succès
                    </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Enregistrer un Blog</h4>
                                                    ...
                                                    <form action="{{ route('AddBlog') }}" method="POST" enctype="multipart/form-data">
                                                      ...
                                                      @method('POST')
                                                        <div class="mb-3">
                                                                ...
                                                                <input name="titre" type="text" id="example-palaceholder" class="form-control" placeholder="Entrer le Titre ">
                                                            </div>

                                                            <div class="mb-3">
                                                                <label for="example-palaceholder" class="form-label">Date</label>
                                                                <input name="date" type="date" id="example-palaceholder" class="form-control" >
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                            <label for="example-fileinput" class="form-label">Joindre une Baniere (OBLIGATOIRE)</label>
...
<script src="{{ asset('dashStyle/assets/vendor/quill/quill.min.js') }}"></script>
<!-- quill Init js-->
<script src="{{ asset('dashStyle/assets/js/pages/demo.quilljs.js') }}"></script>
