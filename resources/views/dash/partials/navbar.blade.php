        ...
        <div class="app-search dropdown">
            <form>
                <div class="input-group">
                    <input type="search" class="form-control dropdown-toggle"  placeholder="Recherche..." id="top-search">
...
<div class="leftside-menu">
    ...
    <a href="/dashboard" class="logo logo-light">
        <span class="logo-lg">
            <img src="assets/images/logo/Jiam_s2-removebg-preview.png" alt="logo" height="130">
        </span>
        <span class="logo-sm">
            <img src="assets/images/logo/Jiam_s4-removebg-preview.png" alt="small logo" height="50">
        </span>
    </a>
    ...
    <a href="/dashboard" class="logo logo-dark">
        <span class="logo-lg">
            <img src="assets/images/logo/Jiam_s3-removebg-preview.png" alt="dark logo" height="60">
        </span>
        <span class="logo-sm">
            <img src="assets/images/logo/Jiam_s5-removebg-preview.png" alt="small logo" height="60">
        </span>
    </a>
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a 
                     class="side-nav-link" href="/dashboard">
