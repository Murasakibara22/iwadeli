...
Route::post('/note_livreur/{etoiles}/{livreur_id}',[NoteController::class, 'createNote'])->middleware('auth:sanctum')->whereNumber('livreur_id'); //notez un livreur avec des etoiles
